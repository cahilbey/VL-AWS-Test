...
if (EW_DEBUG_ENABLED) {
	...
	error_reporting(E_ALL); // Report all errors except E_NOTICE
}
...
define("EW_PROJECT_NAME", "Efes_VL_AWS_Test", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{64847E68-7377-4FEE-94E6-69A0E84D0306}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'X73Gpl28GL4iweUQ', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/Efes_VL_AWS_Test.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "foo", "db" => "vl_aws_test", "qs" => "`", "qe" => "`");
...
define("EW_ALLOW_LOGIN_BY_SESSION", TRUE, TRUE); // Allow login by session variables
...
define("EW_SMTP_SECURE_OPTION", "ssl", TRUE);
...
define("EW_UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,pdf,zip,ai,txt,rtf,psd,psb,tiff,mov,mp4,flv,mkv,rar", TRUE); // Allowed file extensions
...
define("EW_KEEP_ASPECT_RATIO", TRUE, TRUE);
...
// Audit trail
define("EW_AUDIT_TRAIL_PATH", "audit_trail/", TRUE); // Audit trail path (relative to app root)
...
define("EW_BASIC_SEARCH_ANY_FIELDS", TRUE, TRUE); // Search "All keywords" in any selected fields
...
define("EW_MENUBAR_BRAND", "<img src=\"custom-files/img/logo/vl_logo_app.png\">", TRUE);
