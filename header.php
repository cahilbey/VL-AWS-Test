...
<?php } ?>
<link href="phpcss/app.css" rel="stylesheet" type="text/css">
...
<link rel="shortcut icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("vl_favicon_app.ico") ?>"><link rel="icon" type="image/vnd.microsoft.icon" href="<?php echo ew_ConvertFullUrl("vl_favicon_app.ico") ?>">
