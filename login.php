...
<?php include 'custom-files/php/app/login-screen-header.php'; ?>
<?php if ($login->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $login->Token ?>">
<?php } ?>
	<div class="form-group">
		
		<div class="col-sm-10"><input placeholder='Username' type="text" name="username" id="username" class="form-control ewControl" value="<?php echo ew_HtmlEncode($login->Username) ?>"></div>
	</div>
	<div class="form-group">
		
		<div class="col-sm-10"><input placeholder='Password' type="password" name="password" id="password" class="form-control ewControl"></div>
	</div>
	<div class="">
		<div class="">
			<button class="btn-login-submit" name="btnsubmit" id="btnsubmit" type="submit"><?php echo $Language->Phrase("Login") ?></button>
		</div>
	</div>
